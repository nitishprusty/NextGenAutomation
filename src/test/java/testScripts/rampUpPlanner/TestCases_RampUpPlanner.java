package testScripts.rampUpPlanner;
...
public class TestCases_RampUpPlanner extends Login {
	
	RampUpPlanner_Page rampUpPlannerPage;	


	@Test(dependsOnMethods={"LoginApplication"})
	public void rampUpPlannerValidation() throws Exception {

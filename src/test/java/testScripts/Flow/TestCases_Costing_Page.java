...
public class TestCases_Costing_Page extends TestCases_Staffing_Page{
	
	@Test(dependsOnMethods = { "Staffing" })
	public void Costing() throws Exception {
		
		parameter.NavigateToParameter();
		parameter.addDate(ConstantUtils.TestData_Parameter, "NewDSPTestData", 36);

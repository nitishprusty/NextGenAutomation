...
public class TestCases_Pyramids_Page extends TestCases_ProductivityAssessment_Page {
	String OppID_LastActivity = "";

	@Test(dependsOnMethods = { "ProductivityAssessment" })
	public void Pyramids() throws Exception {
